...
class TrainData(data.Dataset):
    def __init__(self, egocentric_root, crop_size=224, divide="Unseen", mask_root=None):
        ...
        if divide == "Seen":
            ...
            self.object_list = ['skateboard', 'bottle', 'knife', 'binoculars', 'laptop', 'soccer_ball', 'scissors', 'hammer', 'badminton_racket', 'skis', 'microwave', 'tennis_racket', 'baseball', 'punching_bag', 'frisbee', 'bed', 'cell_phone', 'keyboard', 'basketball', 'motorcycle', 'orange', 'banana', 'broccoli', 'bicycle', 'snowboard', 'chair', 'apple', 'golf_clubs', 'bowl', 'javelin', 'suitcase', 'drum', 'book', 'couch', 'carrot', 'oven', 'axe', 'toothbrush', 'rugby_ball', 'camera', 'wine_glass', 'bench', 'pen', 'fork', 'cup', 'surfboard', 'discus', 'baseball_bat', 'refrigerator', 'hot_dog']
    ...
    def __getitem__(self, item):
        ...
        obj_label = self.object_list.index(object)
